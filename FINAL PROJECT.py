import pygame
import math
#for now, z is jump, x is run, and shift is dash. to wall jump, be in air, and jump while pressing against a wall. (oh and I temporarily lowered gravity and made the shadow very slow to test wall jumping)
